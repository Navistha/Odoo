        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex sm:flex-col items-center sm:items-center space-x-6 sm:space-x-0 sm:space-y-3 min-w-[60px] order-2 sm:order-1">
            ...
            <div className="flex sm:flex-col items-center space-x-2 sm:space-x-0 sm:space-y-1">
              <Button variant="ghost" size="sm" className="h-6 w-6 sm:h-8 sm:w-8 p-0 hover:text-green-600">
                <ArrowUp className="h-3 w-3 sm:h-4 sm:w-4" />
              </Button>
              <span className={`font-semibold text-sm ${votes > 0 ? 'text-green-600' : votes < 0 ? 'text-red-600' : 'text-muted-foreground'}`}>
                {votes}
              </span>
              <Button variant="ghost" size="sm" className="h-6 w-6 sm:h-8 sm:w-8 p-0 hover:text-red-600">
